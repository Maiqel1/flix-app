// key : 1a021216c32329e1b333774b6db20020
...
const global = {
  ...
  api: {
    apiKey: "1a021216c32329e1b333774b6db20020",
...
//Display backrop on details pages
...
function displayPagination() {
  ...
  //disablee prev on first page
  if (global.search.page === 1) {
    document.querySelector("#prev").disabled = true;
  }

  // disabe next on last page
  ...
  const res = await fetch(
    `${API_URL}${endpoint}?api_key=${API_KEY}%&language=en-US`,
    {
      ...
      headers: {
        ...
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxYTAyMTIxNmMzMjMyOWUxYjMzMzc3NGI2ZGIyMDAyMCIsInN1YiI6IjY2M2Y4NGUxZTY5NTI5NDYxMmRjNDBjZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.c-x4EZIFWq6QNuX4Gt86PY4LszZd-NETiFzuxghqgh0",
      },
    }
  );
